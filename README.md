...
From the equations above, it also follows that for a flash light at height $h$, 
the maximal distance from which it can be seen from water surfece is $\sqrt{2Rh + h^2}$. 
